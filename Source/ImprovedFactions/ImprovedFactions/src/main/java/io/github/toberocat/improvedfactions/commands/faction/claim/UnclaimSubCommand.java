...
public class UnclaimSubCommand extends SubCommand {
    ...
    public UnclaimSubCommand(FactionsHandler factionsHandler) {
        super(factionsHandler, "unclaim", LangMessage.UNCLAIM_DESCRIPTION);
        addSubCommand(new UnclaimOneSubCommand(factionsHandler));
        addSubCommand(new AutoUnclaimSubCommand(factionsHandler));
    }
